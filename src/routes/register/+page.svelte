...
<div class="min-h-screen flex items-center justify-center">
	<Card.Root
		class="w-full max-w-112.5 md:min-w-100 border-3 border-stone-800 bg-stone-900/50 backdrop-blur-xl shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)]
  rounded-2xl p-4"
	>
		<Card.Header>
			<Card.Title
		...
		<Card.Content class="w-full max-w-md">
			<div class="space-y-4">
				...
				>
					<div class="space-y-2">
						<Label class="text-md tracking-widest font-extrabold text-stone-400" for="firstname"
					...
					<div class="space-y-2">
						<Label class="text-md tracking-widest font-extrabold text-stone-400" for="lastname"
   ...
   hover:shadow-[0_0_30px_rgba(255,255,255,0.2)]"
					>
						{loading ? 'Initializing...' : 'Join ThinkStack'}
					</Button>
				</form>
